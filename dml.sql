...
('Alice', 'Roberts', 'aliceroberts@example.com', 'securepassword1', '555-0201', '1982-07-05'),
('Bob', 'Johnson', 'bobjohnson@example.com', 'securepassword2', '555-0202', '1979-12-15');

INSERT INTO Admin (first_name, last_name, email, password, phone, date_of_birth) VALUES
('Carol', 'Taylor', 'caroltaylor@example.com', 'adminpassword1', '555-0301', '1975-03-11'),
('David', 'Smith', 'davidsmith@example.com', 'adminpassword2', '555-0302', '1985-08-19');
